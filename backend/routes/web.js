...
import { createRecipe, deleteRecipe, editRecipe, getRecipeByCategoryId, getRecipeById, listRecipeByStatus, searchRecipesByTitle, trendingRecipe, updateRecipeStatus } from '../controllers/recipeController.js';
...
router.get('/trending-recipes', trendingRecipe);
